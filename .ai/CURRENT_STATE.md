...
**GOAL-056 — تکمیل محتوای راهنمای محصول (in progress, 2026-09-05):** کاتالوگ Help به ۱۵ مقالهٔ دامنه‌ای، registry محدود metadata، جست‌وجوی فارسی سبک، دسته‌بندی Help Center و publication runtime اختلاف‌محور ارتقا یافته است. پذیرش browser و quality gates نهایی در حال اجرا هستند. GOAL-057 آغاز نشده است.

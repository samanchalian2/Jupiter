...
**GOAL-057 — Appearance Theme Migration & Custom Primary Validation (accepted, 2026-09-06):** Jupiter Light Theme primary is `#315399`; nullable Platform/Organization Custom Primary persistence, server WCAG validation with deterministic white/dark `onPrimary`, runtime inheritance and Persian preview controls are complete. Runtime Help was revised and published. Authenticated Platform/Organization Browser acceptance at 375/768/1024/1440 passed with no document overflow; all temporary test user/session/profile data and test overrides were removed or reset. API/Web tests, typechecks, builds, migration rehearsal and diff check pass. Evidence: `docs/GOAL_057_EVIDENCE.md`. GOAL-058 is not started.

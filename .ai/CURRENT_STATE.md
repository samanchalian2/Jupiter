...
**GOAL-056 — تکمیل محتوای راهنمای محصول (in progress, 2026-09-06):** کاتالوگ Help به ۱۵ مقالهٔ دامنه‌ای، registry محدود metadata، جست‌وجوی فارسی سبک، دسته‌بندی Help Center و publication runtime اختلاف‌محور ارتقا یافت. پذیرش Browser برای Help Center، جست‌وجو/مقاله، Triggerهای Composer/Detail/Members و Help Authoring Platform در 375/768/1024/1440 بدون document-level overflow ثبت شده است؛ اما تمام مسیرهای الزامی contextual و quality gateهای نهایی هنوز یک‌جا بازپذیرفته نشده‌اند. remediation پذیرش، Trigger «راهنمای چرخهٔ تیکت» را به Ticket Detail افزود و anchor popover را برای جلوگیری از overflow اصلاح کرد. Evidence: `docs/GOAL_056_EVIDENCE.md`. GOAL-057 آغاز نشده است.

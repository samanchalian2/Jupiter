...
export class AssistController {
  ...
  @Post('capacity/packages/:id/status') packageStatus(@Param('id') id:string,@Body() body:{status?:'ACTIVE'|'SUSPENDED';reason?:string},@Headers('authorization') authorization?:string) { return this.user(authorization).then(userId=>this.capacity.setPackageStatus(userId,id,body)); }

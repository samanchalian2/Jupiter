...
export class ReportingController {
  ...
  @Get('dashboard/overview') overview(@Headers('authorization') authorization?: string, @Headers('x-organization-id') organizationId?: string) { return this.actor(authorization, organizationId).then((actor) => this.reports.overview(actor)); }
  @Get('reports/summary') summary(@Query('from') from: string, @Query('to') to: string, @Headers('authorization') authorization?: string, @Headers('x-organization-id') organizationId?: string) { return this.actor(authorization, organizationId).then((actor) => this.reports.summary(actor, { from, to })); }
  @Get('reports/breakdown') breakdown(@Query('from') from: string, @Query('to') to: string, @Headers('authorization') authorization?: string, @Headers('x-organization-id') organizationId?: string) { return this.actor(authorization, organizationId).then((actor) => this.reports.breakdown(actor, { from, to })); }
  @Get('reports/export') export(@Query('from') from: string, @Query('to') to: string, @Headers('authorization') authorization?: string, @Headers('x-organization-id') organizationId?: string) { return this.actor(authorization, organizationId).then((actor) => this.reports.exportCsv(actor, { from, to })); }
